...
class HappinessPredictions(BASE):
    ...
    Region_East_Europe = Column(Integer, nullable=False)
    Region_North_Africa = Column(Integer, nullable=False)
    Region_Oceania = Column(Integer, nullable=False)
    Region_South_Africa= Column(Integer, nullable=False)
    Region_West_Europe= Column(Integer, nullable=False)
